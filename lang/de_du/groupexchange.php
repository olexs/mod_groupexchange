...
$string['email_body'] = 
'Dein Gruppentauschangebot in \'{$a->exchange}\' (Kurs: \'{$a->course}\') wurde von einem anderen Teilnehmer angenommen.
...
$string['standing_offers'] = 'Stehende Gruppentauschangebote';
...
$string['no_offers'] = 'Es gibt derzeit keine stehenden Angebote.';
...
$string['fitting_offers'] = 'Es wurden folgende stehende Tauschangebote gefunden, die deinen Angaben entsprechen. Vielleicht möchtest du einen davon annehmen, anstatt einen eigenen Angebot zu erstellen.';
$string['submit_offer_ignore'] = 'Stehende Angebote ignorieren, meinen Tauschangebot erstellen';
